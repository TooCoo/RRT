...
class pp_pub():
    ...
    def __init__(self):
        ...
        self.pp_request.points.append(p2)
        ...
        while not rospy.is_shutdown():
            ...
            if (self.counter > self.counterMax):
                ...
                p1 = Point()
                p1.x = random.uniform(0, 10)
                p1.y = random.uniform(0, 10)
                p1.z = 1.0

                p2 = Point()
                p2.x = random.uniform(0, 10)
                p2.y = random.uniform(0, 10)
                p2.z = 1.0

                self.pp_request.points[0] = p1
                self.pp_request.points[1] = p2
